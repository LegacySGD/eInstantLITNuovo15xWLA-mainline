...
var scenario = getScenario(jsonContext);
    var scenarioWinNums = scenario.split(',').slice(0, 4);
    var scenarioBonusNum = scenario.split(',')[4];
    var scenarioYourNums = scenario.split(',').slice(5);
    ...
    objBonusNum.sValue = scenarioBonusNum.replace(new RegExp('[*]', 'g'), '');
    objBonusNum.bMatched = (scenarioBonusNum[0] == '*');
    ...
    for (var indexYourNum = 0; indexYourNum < scenarioYourNums.length; indexYourNum++) {
        ...
        objYourNum.sValue = arrYourNumParts[0].replace(new RegExp('[*]', 'g'), '');
        objYourNum.sPrize = arrYourNumParts[1];
        objYourNum.bIW = (objYourNum.sValue[0] == 'X');
        objYourNum.bMatched = (!objYourNum.bIW && arrYourNumParts[0][0] == '*');
