...
public class LITNuovo15xWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITNuovo15xWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITNuovo15xWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITNuovo15xWLAIW/InitOutcome.xml").getDocumentElement();
